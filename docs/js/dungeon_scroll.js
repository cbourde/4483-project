...
// Number of Active Enemies in dungeon to trigger victory condition
...
window.addEventListener('load', function(){
        ...
        update(input, enemies) {
            ...
            enemies.forEach(enemy => {
                ...
                if(distance < enemy.width + this.width - 30){
                    window.location.href = "dungeon_battle.html";
                    fight = true;
                } 
            });
    ...
    class Enemy {
        ...
        draw(context){
            //context.strokeStyle = 'white';
            //context.strokeRect(this.x, this.y, this.width, this.height);
            context.drawImage(this.image, this.frameX *  this.width, 0, this.width, this.height, this.x, ENEMY_Y - 30, this.width, this.height);
    ...
    function handleEnemies(deltaTime) {
        if(enemyTimer > enemyInterval + randomEnemyInterval && !fight && TOTAL_ENEMIES != 0) {
